...
<!-- I think the idea of this interactive plot was different in class than how I used it. I think my way is still alright to visualize but let me know if you would prefer it in a different way.-->
```{code-cell}
...
<!-- To be honest I am really struggling to put something extra meaningful into this part. Any suggestions what to add? I tried to work in the Recap part of 3a because with the help of that things actually made more sense.-->

So now how do we  find $w_0$ and $w_1$? 

First we take the formula we have and derive it (we added $\frac{1}{2}$ to make the calculation easier but it does not change the optimal $w_0$ and $w_1$): 
